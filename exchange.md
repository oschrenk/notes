...
MIME
Extends format of Email such as Non-text, multiple parts.

Content-ID. Header. Is a unique identifier. Mainly used for multi-part messages, allowing to reference each part.

Content-Type: Indicates Internet Media Type eg. `plain/text`
...
ttp://www.ietf.org/rfc/rfc2387.txt
...
Correct usa of multipart/related
...
http://msdn.microsoft.com/en-us/library/aa486282(v=EXCHG.65).aspx

### Solutions

## fetchExc

FetchExc is java utility which retrieves mail from your MS Exchange (2000/2003) inbox and forwards it to SMTP server of your choice or mbox type file. FetchExc uses webDAV to retrieve mail either over http or https

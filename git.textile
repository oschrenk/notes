...
h4. Restore deleted file

bc. git checkout HEAD^ foo.bar
...
bc. git update-index --no-assume-unchanged <file>


h3. Remove last commit from history

bc. git rebase --onto HEAD~1 HEAD

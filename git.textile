...
save it to @~/username/users.txt@. The file contents have to look similiar
to this:
...
Github needs you to set 

h3. Push repository to Github

Set up the repo on github using "github.com/repositories/new":http://github.com/repositories/new

Github tells you what to do next, which is "setting up a local repo":#create-local-repo, making your commits, configure your local repo and push it.
